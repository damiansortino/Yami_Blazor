...
namespace LaymarClientSide.Server.Migrations
{
    ...
    [Migration("20200209015845_ComporbanteEnMovimientoCaja")]
    partial class ComporbanteEnMovimientoCaja
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LaymarClientSide.Shared.Entidades.UserSucursal", b =>
                {
                    b.Property<int>("UserSucursalId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("UserSucursalId");

                    b.HasIndex("SucursalId");

                    b.ToTable("userSucursal");
                });
